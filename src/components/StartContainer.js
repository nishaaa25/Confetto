    ...
    <div className="start">
      <div className="start-content container text-center p-7">
        <div className="start-text pt-10 pb-3">
          ...
          <p className="info-text mb-10 w-[29%] mx-auto">
            Are you ready to take control of your finances and start your
            financial journey? Look no further than our platform.
          </p>
        </div>
        <div className="my-4">
          <div className="flex-between gap-[30px] relative w-full h-[684px] overflow-hidden">
            <div className="w-[418px] h-full relative">
              <div className="grid grid-cols-2 gap-[30px] w-full h-[194px] relative ">
                ...
                <div className="bg-black-800 object-cover rounded-[20px] flex-center">
                  <img src={asset25} alt="calendarIcon" className="w-16" />
                </div>
              </div>
              <div className="flex-between overflow-hidden h-[460px] mt-[30px] bg-black-800 rounded-[20px] relative">
                <img
                  src={asset34}
                  alt="transactionImg"
                  className="w-[46%] rounded-[30px]"
                />
                <img
                  src={asset35}
                  alt="transactionImg"
            ...
            <div className="w-[836px] h-full bg-black-800 rounded-[20px] overflow-hidden relative">
          ...
          <div className="w-full h-[353px] grid grid-cols-2 gap-[30px] mt-[30px]">
            <div className="bg-black-800 relative rounded-[20px] py-10">
              <div className="w-full flex-between mb-[30px]">
                <img src={asset39} alt="logo" className="w-16" />
                <img src={asset40} alt="logo" className="w-16" />
                <img src={asset41} alt="logo" className="w-16" />
                <img src={asset42} alt="logo" className="w-16" />
                <img src={asset43} alt="logo" className="w-16" />
                <img src={asset44} alt="logo" className="w-16" />
              </div>
              <div className="w-full flex-between">
                <img src={asset45} alt="logo" className="w-16" />
                <img src={asset46} alt="logo" className="w-16" />
                <img src={asset47} alt="logo" className="w-16" />
                <img src={asset48} alt="logo" className="w-16" />
                <img src={asset49} alt="logo" className="w-16" />
                <img src={asset50} alt="logo" className="w-16" />
              </div>
